...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        private final AndroidxAppLibraryAccessors laccForAndroidxAppLibraryAccessors = new AndroidxAppLibraryAccessors(owner);
        private final AndroidxCoreLibraryAccessors laccForAndroidxCoreLibraryAccessors = new AndroidxCoreLibraryAccessors(owner);
        private final AndroidxEspressoLibraryAccessors laccForAndroidxEspressoLibraryAccessors = new AndroidxEspressoLibraryAccessors(owner);
        private final AndroidxJetpackLibraryAccessors laccForAndroidxJetpackLibraryAccessors = new AndroidxJetpackLibraryAccessors(owner);
        private final AndroidxLifecycleLibraryAccessors laccForAndroidxLifecycleLibraryAccessors = new AndroidxLifecycleLibraryAccessors(owner);
        private final AndroidxNavigationLibraryAccessors laccForAndroidxNavigationLibraryAccessors = new AndroidxNavigationLibraryAccessors(owner);
        private final AndroidxRetrofitLibraryAccessors laccForAndroidxRetrofitLibraryAccessors = new AndroidxRetrofitLibraryAccessors(owner);
         ...
         * with version reference <b>paging3Version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Group of libraries at <b>androidx.app</b>
         */
        public AndroidxAppLibraryAccessors getApp() {
            return laccForAndroidxAppLibraryAccessors;
        }
        ...
        /**
         * Group of libraries at <b>androidx.jetpack</b>
         */
        public AndroidxJetpackLibraryAccessors getJetpack() {
            return laccForAndroidxJetpackLibraryAccessors;
        }
        ...
        /**
         * Group of libraries at <b>androidx.retrofit</b>
         */
        public AndroidxRetrofitLibraryAccessors getRetrofit() {
            return laccForAndroidxRetrofitLibraryAccessors;
        }
    ...
    public static class AndroidxAppLibraryAccessors extends SubDependencyFactory {

        public AndroidxAppLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compat</b> with <b>androidx.appcompat:appcompat</b> coordinates and
         * with version reference <b>appcompat</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompat() {
            return create("androidx.app.compat");
        }
    ...
    public static class AndroidxJetpackLibraryAccessors extends SubDependencyFactory {
        private final AndroidxJetpackCoroutinesLibraryAccessors laccForAndroidxJetpackCoroutinesLibraryAccessors = new AndroidxJetpackCoroutinesLibraryAccessors(owner);

        public AndroidxJetpackLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>androidx.jetpack.coroutines</b>
         */
        public AndroidxJetpackCoroutinesLibraryAccessors getCoroutines() {
            return laccForAndroidxJetpackCoroutinesLibraryAccessors;
        }

    }

    public static class AndroidxJetpackCoroutinesLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxJetpackCoroutinesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("androidx.jetpack.coroutines");
        }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("androidx.jetpack.coroutines.core");
        }
    ...
    public static class AndroidxRetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxRetrofitLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("androidx.retrofit");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getGson() {
            return create("androidx.retrofit.gson");
        }

        /**
         * Dependency provider for <b>logging</b> with <b>com.squareup.okhttp3:logging-interceptor</b> coordinates and
         * with version reference <b>retrofitLoggingVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getLogging() {
            return create("androidx.retrofit.logging");
        }
    ...
    public static class DaggerHiltLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>daggerHiltVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
        ...
        /**
         * Dependency provider for <b>complier</b> with <b>com.google.dagger:hilt-compiler</b> coordinates and
         * with version reference <b>daggerHiltVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getComplier() {
            return create("dagger.hilt.complier");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>daggerHiltVersion</b> with value <b>2.51.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDaggerHiltVersion() { return getVersion("daggerHiltVersion"); }
        ...
        /**
         * Version alias <b>kapt</b> with value <b>2.0.10</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>paging3Version</b> with value <b>3.3.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPaging3Version() { return getVersion("paging3Version"); }

        /**
         * Version alias <b>retrofitLoggingVersion</b> with value <b>4.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRetrofitLoggingVersion() { return getVersion("retrofitLoggingVersion"); }
    ...
    public static class GooglePluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>google.hilt</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>daggerHiltVersion</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getHilt() { return createPlugin("google.hilt"); }
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>kapt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
